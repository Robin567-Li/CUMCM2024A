...
for theta1 = 26.0:0.1:26.2%26.1465965779221
        ...
        d2 = 0.275;
        d1 = 0.15;
        u9t = (11/(40*pi)).*theta9*cos(theta9);
        ...
        d = abs(k*(xa1-u9t)-ya1+v9t) ./ sqrt(1+k^2) ;
        yy = [(11/(40*pi))*theta10*sin(theta10), (11/(40*pi))*theta9*sin(theta9)];
        xx = [(11/(40*pi))*theta10*cos(theta10), (11/(40*pi))*theta9*cos(theta9)];
        plot(xx,yy)
        hold on
        scatter(xa1,ya1)
        pause(0.2)
